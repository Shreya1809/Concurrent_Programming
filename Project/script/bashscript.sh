#!/bin/bash
echo "Lab1 - Sorting a text file of intergers using Quicksort "

PROGRAM_PATH="/home/shreya1809/Concurrent_Programming/Lab1"
EXE_PATH="/home/shreya1809/Concurrent_Programming/Lab1/bin"
FILE_PATH="/home/shreya1809/Concurrent_Programming/Lab1/files"
            ...
            "Sort files by my sorting method" )
                ...
                if [ $option -eq 1 ] ; then
                        ...
                        if [ $option -eq 2 ] ; then
                                ...
                                echo "Complining the quicksort program...."
                                pushd $PROGRAM_PATH
                                    make
                                popd
                                quickoption=3 
